...
const Home: NextPage<Props> = async () => {
  ...
  return (
    <div className="container mx-auto max-w-2xl flex flex-col space-y-2">
      <StoryblokStory story={data.story} />

      <h1 className="font-semibold text-2xl">Welcome to my blog!</h1>
      <p className="leading-7">
        Hey there! I'm Kien Dang, a second-year student Fontys University of
        Applied Sciences. I'm currently studying ICT & Media Design, focussing
        on webdesign and development. At the moment I'm more into front-end
        developement rather than webdesign.
        <br />
        <br />
